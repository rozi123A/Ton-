...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "chat.another_person": "شخص آخر",
    "chat.radar_btn": "الرادار",
    "chat.mic": "ميكروفون",
    "chat.cam": "كاميرا",
    "chat.audio": "صوت",
    "chat.chat_btn": "دردشة",
    ...
    "common.loading": "جاري التحميل...",
     ...
     "notifications.enable_button": "السماح",
      "notifications.test_push": "اختبار إشعار الهاتف",
      "notifications.test_push_description": "اضغط للتأكد أن الإشعار يظهر في لوحة الهاتف.",
      "notifications.activate_push": "تفعيل إشعارات الهاتف",
      "notifications.activate_push_registering": "جارٍ التفعيل...",
      "notifications.activate_push_failed": "تعذر تسجيل الهاتف؛ اضغط للتفعيل من جديد.",
      "notifications.test_push_sending": "جارٍ إرسال الاختبار...",
      "notifications.test_push_sent": "تم الإرسال؛ تحقق من لوحة الهاتف.",
      "notifications.test_push_missing": "لم يُسجّل هذا الهاتف بعد. اسمح بالإشعارات وأعد فتح الموقع.",
  ...
  en: {
    ...
    "chat.stop_btn": "End",
    "chat.next_btn": "Next",
    "chat.another_person": "Another Person",
    "chat.radar_btn": "Radar",
    "chat.mic": "Mic",
    "chat.cam": "Camera",
    "chat.audio": "Audio",
    "chat.chat_btn": "Chat",
    ...
    "common.loading": "Loading...",
     ...
     "notifications.enable_button": "Allow",
      "notifications.test_push": "Test phone notification",
      "notifications.test_push_description": "Tap to confirm the alert appears in your phone's notification shade.",
      "notifications.activate_push": "Enable phone notifications",
      "notifications.activate_push_registering": "Enabling...",
      "notifications.activate_push_failed": "Phone registration failed; tap to retry.",
      "notifications.test_push_sending": "Sending test...",
      "notifications.test_push_sent": "Sent; check your phone's notification shade.",
      "notifications.test_push_missing": "This phone is not registered yet. Allow notifications and reopen the site.",
  ...
  fr: {
    ...
    "chat.stop_btn": "Quitter",
    "chat.next_btn": "Suivant",
    "chat.another_person": "Autre personne",
    "chat.radar_btn": "Radar",
    "chat.mic": "Micro",
    "chat.cam": "Caméra",
    "chat.audio": "Audio",
    ...
    "common.loading": "Chargement...",
     ...
     "notifications.enable_button": "Autoriser",
      "notifications.test_push": "Tester la notification du téléphone",
      "notifications.test_push_description": "Appuyez pour vérifier l'affichage dans le panneau du téléphone.",
      "notifications.activate_push": "Activer les notifications du téléphone",
      "notifications.activate_push_registering": "Activation...",
      "notifications.activate_push_failed": "Échec de l'inscription ; appuyez pour réessayer.",
      "notifications.test_push_sending": "Envoi du test...",
      "notifications.test_push_sent": "Envoyé ; vérifiez le panneau du téléphone.",
      "notifications.test_push_missing": "Ce téléphone n'est pas encore enregistré. Autorisez les notifications et rouvrez le site.",
     "notifications.title": "Notifications",
